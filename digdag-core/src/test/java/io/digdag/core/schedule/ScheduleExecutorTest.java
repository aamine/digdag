...
public class ScheduleExecutorTest
{
            ...
            throws Exception
    {
        ...
        doAnswer(invocation -> {
            ScheduleStoreManager.ScheduleAction func = invocation.getArgument(3);
            ...
            throws Exception
    {
        ...
        when(sessionStore.getActiveAttemptsOfWorkflow(eq(PROJECT_ID), eq(WORKFLOW_NAME), anyInt(), any()))
